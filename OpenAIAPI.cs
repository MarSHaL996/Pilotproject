...
namespace OpenAI_API
{
	...
	public class OpenAIAPI : IOpenAIAPI
	{
        ...
        /// </summary>
        public string ApiUrlFormat { get; set; } = "https://api.openai.com/v1/completions";
        //public string ApiUrlFormat { get; set; } = "https://openai-test-summary.openai.azure.com/{0}/{1}";
